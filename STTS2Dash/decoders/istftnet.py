...
#     def __init__(self, dim_in, dim_out, style_dim=128, actv=nn.LeakyReLU(0.2),
...
#         self.decode.append(AdainResBlk1d(1024 + 2 + 128, 1024, style_dim))
#         self.decode.append(AdainResBlk1d(1024 + 2 + 128, 1024, style_dim))
#         self.decode.append(AdainResBlk1d(1024 + 2 + 128, 1024, style_dim))
#         self.decode.append(AdainResBlk1d(1024 + 2 + 128, 1024, style_dim, upsample=True))
...
#             weight_norm(nn.Conv1d(1024, 128, kernel_size=1)),
#         )
