...
def build_model(args, is_vokan=False, is_tsukasa=False):
    args = recursive_munch(args)

    if args.decoder.type == "istftnet":
        from ..decoders.istftnet import Decoder
        ...
        raise AssertionError(f"Decoder type unsupported | Valid: {args.decoder.type}")
